...
public class BoxPlotRecordLong {
  public long min, q1, median, q3, max, iqr;
  public List<Long> outliers = new ArrayList<>();

  public static BoxPlotRecordLong calculateBoxPlot(List<Long> data) {
    if (data == null || data.isEmpty()) {
      throw new IllegalArgumentException("Data list cannot be null or empty");
    }

    BoxPlotRecordLong record = new BoxPlotRecordLong();
  ...
  private static long getMedian(List<Long> data) {
    int size = data.size();
