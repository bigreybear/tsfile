...
public class CCSLoaderV2 extends StreamingLoader<CCSLoaderV2> {

  private String ent, dev;

  public CCSLoaderV2(MergedDataSets mds) throws FileNotFoundException {
    super(mds);
  }

  public CCSLoaderV2(File file) throws FileNotFoundException {
    super(file);
  }
